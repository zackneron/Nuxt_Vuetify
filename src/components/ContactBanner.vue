<template>
  <section class="contact container-banner">
      ...
      <div class="wrap white--text">
        <v-container>
          <v-row>
            <v-col cols="12">
              <div
                class="hero d-flex flex-column flex-md-row justify-md-space-between align-md-center"
              >
...
.contact {
  &.container-banner {
    background-image: url("../assets/oil_water@1x.png");
