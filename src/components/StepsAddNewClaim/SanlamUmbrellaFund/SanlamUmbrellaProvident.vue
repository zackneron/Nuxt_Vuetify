                        ...
                        <v-container>
                            <v-row>
                                <v-col cols="12" class="pa-0">
                                    ...
                                    <h2 class="mb-6 black--text">Sanlam Umbrella Provident Fund</h2>
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col cols="12" class="pa-0">
                                    ...
                                    <v-radio-group v-model="selectedPaymentOption" column hide-details="auto">
                                        <v-radio
                                            ...
                                            value="SameAsPensionFund"
                                            class="mb-2 pa-2 radio-item"
                                            :class="{ focus: isFocusProvidentFund }"
                                            :disabled="disableSameAsPensionOption"
                                            @change="showSamePaymentProvidentFund"
                                        >
                                            <template #label>
                                                <div class="d-flex justify-space-between align-center flex-grow-1">
                                                    <span>Same payment options as Sanlam Umbrella Pension Fund </span>
                                                    <v-btn
                                    ...
                                    <!-- Option 2 -->
                                    <div v-if="showBenefitProvidentFundText" class="pa-2">
                                        <DividerBar />
                                        <LeaveBenefitFundContent />
                                    </div>

                                    <!-- Option 3 -->
                                    <div v-if="showTransferProvidentFundText" class="pa-2">
                                        <DividerBar />
                                        <div class="mt-4">
                                            ...
                                            <v-radio-group v-model="transferFullBenefit" column class="mt-0">
                                                <div
                                                    v-if="viewSanlamPlusProvidentFund"
                                                    v-show="isFocusInner"
                                                    :class="{
                                                        focus: isFocusInner,
                                                    }"
                                                ...
                                                >
                                                    <v-radio
                                                        ...
                                                        @click="showSanlamPlusProvidentFund"
                                                    ></v-radio>
                                                    <v-btn
                                            ...
                                            <div v-if="showSanlamPlusProvidentFundText" class="pa-2">
                                            ...
                                            <div v-if="showRetirementAnnuityFundProvidentFundText" class="pa-2">
                                                <DividerBar />
                                                <div class="mt-4">
                                                    <v-card-title class="text-h5 px-0 black--text">
                                                        Broker / Representative Details
                                    ...
                                    <!-- Option 4 -->
                                    <div v-if="showPayPortionProvidentFundText" class="pa-2">
                                        <DividerBar />
                                        <div class="mt-4">
                                            <v-card-title class="text-h5 px-0 black--text">
                                            ...
                                            >
                                                <div
                                                    v-if="viewPayPortionSanlamPlusProvidentFund"
                                                    v-show="isFocusInner"
                                                    :class="{
                                                        focus: isFocusInner,
                                                    }"
                                                ...
                                                >
                                                    <v-radio
                                                        label="Sanlam Plus Preservation Fund"
                                                        value="Sanlam Plus Preservation Fund"
                                                        @click="showPayPortionSanlamPlusProvidentFund"
                                                    ></v-radio>
                                                    <v-btn
                                                        v-show="isActiveInner"
                                                        text
                                                ...
                                                <div
                                                    v-if="viewPayPortionRetirementAnnuityFundProvidentFund"
                                                    v-show="isFocusInner"
                                                    :class="{
                                                        focus: isFocusInner,
                                                    }"
                                                ...
                                                >
                                                    <v-radio
                                                        label="A Retirement Annuity Fund, Pension Fund, Provident Fund or other Preservation Fund"
                                                        value="A Retirement Annuity Fund, Pension Fund, Provident Fund or other Preservation Fund"
                                                        @click="showPayPortionRetirementAnnuityFundProvidentFund"
                                                    ></v-radio>
                                                    <v-btn
                                                        v-show="isActiveInner"
                                                        text
                                            ...
                                            <div v-if="showPayPortionSanlamPlusProvidentFundText" class="pa-2">
                                                <div
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <small
                                                        v-if="v$.cashPortionSanlamPlusProvidentFund.$error"
                                                        class="validate-field"
                                                    >
                                                        Please select a payment option.
                                                    </small>
                                                    <v-radio-group
                                                        v-model="cashPortionSanlamPlusProvidentFund"
                                                        column
                                                        class="mt-0"
                                                    >
                                                        <div
                                                            v-if="viewPayPortionBenefitSanlamPlusProvidentFund"
                                                            v-show="isFocusLast"
                                                            :class="{
                                                                focus: isFocusLast,
                                                            }"
                                                        ...
                                                        >
                                                            <v-radio
                                                                ...
                                                                @click="showPayPortionBenefitSanlamPlusProvidentFund"
                                                            ></v-radio>
                                                            <v-btn
                                                                v-show="isActiveLast"
                                                                text
                                                        ...
                                                        <div
                                                            v-if="viewTransferAmountSanlamPlusProvidentFund"
                                                            v-show="isFocusLast"
                                                            :class="{
                                                                focus: isFocusLast,
                                                            }"
                                                        ...
                                                        >
                                                            <v-radio
                                                                ...
                                                                @click="showTransferAmountSanlamPlusProvidentFund"
                                                            ></v-radio>
                                                            <v-btn
                                                                v-show="isActiveLast"
                                                                text
                                                    ...
                                                    <div
                                                        v-if="showPayPortionBenefitSanlamPlusProvidentFundText"
                                                        class="pa-2"
                                                    >
                                                        <DividerBar />
                                                        <PortionBenefitCash />
                                                    ...
                                                    <div
                                                        v-if="showTransferAmountSanlamPlusProvidentFundText"
                                                        class="pa-2"
                                                    >
                                                        <DividerBar />
                                                        <div class="mt-4">
                                            ...
                                            <div
                                                v-if="showPayPortionRetirementAnnuityFundProvidentFundText"
                                                class="pa-2"
                                            >
                                                <div
                                                    v-if="isLeftOverBalanceFromTheTransferToSanlamPlusPreservationFund"
                                                ...
                                                <div class="mt-4">
                                                    ...
                                                    <v-radio-group v-model="cashRetirementPayment" column class="mt-0">
                                                        <div
                                                            v-if="viewRetirementPayPortionBenefitProvidentFund"
                                                            v-show="isFocusLast"
                                                            :class="{
                                                                focus: isFocusLast,
                                                            }"
                                                        ...
                                                        >
                                                            <v-radio
                                                                label="Percentage (%) or (R) Rand value. The balance will be transferred to Sanlam Plus Preservation fund."
                                                                value="PercentageRandValue"
                                                                @click="showRetirementPayPortionBenefitProvidentFund"
                                                            ></v-radio>
                                                            <v-btn
                                                                v-show="isActiveLast"
                                                                text
                                                        ...
                                                        <div
                                                            v-if="viewRetirementPayTransferAmountProvidentFund"
                                                            v-show="isFocusLast"
                                                            :class="{
                                                                focus: isFocusLast,
                                                            }"
                                                        ...
                                                        >
                                                            <v-radio
                                                                label="The left over balance from the transfer to Sanlam Plus Preservation fund."
                                                                value="leftOverBalanceFromTransferToSanlamPlusPreservationFund"
                                                                @click="showRetirementPayTransferAmountProvidentFund"
                                                            ></v-radio>
                                                            <v-btn
                                                                v-show="isActiveLast"
                                                                text
                                                    ...
                                                    <!-- I want to pay a portion of the benefit in cash -->
                                                    <div
                                                        v-if="showRetirementPayPortionBenefitProvidentFundText"
                                                        class="pa-2"
                                                    >
                                                        <DividerBar />
                                                        <PortionBenefitCash />
                                                    ...
                                                    <!-- I want to transfer an amount to the Sanlam Plus Preservation Fund -->
                                                    <div
                                                        v-if="showRetirementTransferAmountProvidentFundText"
                                                        class="pa-2"
                                                    >
                                                        <DividerBar />
                                                        <div class="mt-4">
                                                        ...
                                                        <div class="mt-4">
                                                            ...
                                                            <FinancialRepresentative
                                                                v-if="showRetirementFinRepresentative"
                                                            />
                                                            <v-row>
                                                                <v-col cols="12">
                                                                    <div grey class="text-bg-info py-6 px-7">
                                    ...
                                    <!-- Option 5 -->
                                    <div v-if="showFullBenefitProvidentFundText" class="pa-2">
                                        <DividerBar />
...
export default {
    ...
    validations() {
        return {
            ...
            transferFullBenefit: {
                required: requiredIf(this.showTransferProvidentFundText === true),
            },
            radioPayAPortionOfBenefitInCash: {
                required: requiredIf(this.showPayPortionProvidentFundText === true),
            },
            cashPortionSanlamPlusProvidentFund: {
                required: requiredIf(this.showPayPortionSanlamPlusProvidentFundText === true),
            },
            cashRetirementPayment: {
                required: requiredIf(this.showPayPortionRetirementAnnuityFundProvidentFundText === true),
            },
        }
    },
    data() {
        return {
            ...
            cashPortionSanlamPlusProvidentFund: null,
            ...
            viewSanlamPlusProvidentFund: true,
            viewRetirementAnnuityFundProvidentFund: true,

            viewPayPortionSanlamPlusProvidentFund: true,
            viewPayPortionRetirementAnnuityFundProvidentFund: true,
            showPayPortionSanlamPlusProvidentFundText: false,
            showRetirementTransferAmountProvidentFundText: false,

            showPayPortionBenefitSanlamPlusProvidentFundText: false,
            viewPayPortionBenefitSanlamPlusProvidentFund: true,
            viewTransferAmountSanlamPlusProvidentFund: true,
            showTransferAmountSanlamPlusProvidentFundText: false,
            ...
            showSanlamPlusProvidentFundText: false,
    ...
    methods: {
        ...
        toggleChangeInnerOption(e) {
            ...
            this.viewSanlamPlusProvidentFund = true
            this.viewRetirementAnnuityFundProvidentFund = true
            this.showSanlamPlusProvidentFundText = false
            this.showRetirementAnnuityFundProvidentFundText = false

            this.viewPayPortionSanlamPlusProvidentFund = true
            this.viewPayPortionRetirementAnnuityFundProvidentFund = true
            this.showPayPortionSanlamPlusProvidentFundText = false
        ...
        toggleChangeLastOption(e) {
            ...
            this.showPayPortionBenefitSanlamPlusProvidentFundText = false
            this.viewPayPortionBenefitSanlamPlusProvidentFund = true

            this.showTransferAmountSanlamPlusProvidentFundText = false
            this.viewTransferAmountSanlamPlusProvidentFund = true
        ...
        showSanlamPlusProvidentFund() {
            this.isActiveInner = true
            this.isFocusInner = true

            this.showSanlamPlusProvidentFundText = true
            this.showRetirementAnnuityFundProvidentFundText = false
        ...
        showRetirementAnnuityFundProvidentFund() {
            ...
            this.viewSanlamPlusProvidentFund = false
            this.viewRetirementAnnuityFundProvidentFund = true
        },

        showPayPortionSanlamPlusProvidentFund() {
            this.isActiveInner = true
            this.isFocusInner = true

            this.showPayPortionSanlamPlusProvidentFundText = true
            this.showPayPortionRetirementAnnuityFundProvidentFundText = false
        ...
        showPayPortionRetirementAnnuityFundProvidentFund() {
            ...
            this.viewPayPortionSanlamPlusProvidentFund = false
            this.viewPayPortionRetirementAnnuityFundProvidentFund = true
        },

        showPayPortionBenefitSanlamPlusProvidentFund() {
            this.isActiveLast = true
            this.isFocusLast = true

            this.showPayPortionBenefitSanlamPlusProvidentFundText = true
            this.viewPayPortionBenefitSanlamPlusProvidentFund = true

            this.showTransferAmountSanlamPlusProvidentFundText = false
            this.viewTransferAmountSanlamPlusProvidentFund = false

            this.isLeftOverBalanceFromTheTransferToSanlamPlusPreservationFund = false
        },
        showTransferAmountSanlamPlusProvidentFund() {
            this.isActiveLast = true
            this.isFocusLast = true

            this.showPayPortionBenefitSanlamPlusProvidentFundText = false
            this.viewPayPortionBenefitSanlamPlusProvidentFund = false

            this.showTransferAmountSanlamPlusProvidentFundText = true
            this.viewTransferAmountSanlamPlusProvidentFund = true
