                ...
                <v-col cols="12" class="pa-0">
                  ...
                  <div v-show="showTransferProvidentFundText" class="pa-2">
                    ...
                    <div class="mt-4">
                      ...
                      <div
                        v-show="showSanlamPlusProvidentFundText"
                        class="pa-2"
                      >
                  ...
                  <div v-show="showPayPortionProvidentFundText" class="pa-2">
                    ...
                    <div class="mt-4">
                      ...
                      <div
                        v-show="showPayPortionSanlamPlusProvidentFundText"
                        class="pa-2"
                      >
                        <div grey class="text-bg-info py-6 px-7 mb-3">
                          <div class="d-flex align-start">
                        ...
                        <div class="mt-4">
                          ...
                          >
                            <div
                              v-if="
                                viewPayPortionBenefitSanlamPlusProvidentFund
                              "
                              v-show="isFocusLast"
                              :class="{
                                focus: isFocusLast,
                          ...
                          <div
                            v-show="
                              showPayPortionBenefitSanlamPlusProvidentFundText
                            "
                            class="pa-2"
                          >
                            <DividerBar />
                          ...
                          <div
                            v-show="
                              showTransferAmountSanlamPlusProvidentFundText
                            "
                            class="pa-2"
                          >
                            <DividerBar />
